...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React43 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef20 = React43.useRef, useEffect10 = React43.useEffect, useMemo19 = React43.useMemo, useDebugValue2 = React43.useDebugValue;
...
function useTriggerRegistration(id, store) {
  const registeredElementIdRef = React19.useRef(null);
  const registeredElementRef = React19.useRef(null);
  return React19.useCallback((element) => {
    if (id === void 0) {
      return;
    }
...
function useInteractions(propsList = []) {
  ...
  const getReferenceProps = React25.useCallback(
    (userProps) => mergeProps(userProps, propsList, "reference"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    referenceDeps
  );
  const getFloatingProps = React25.useCallback(
    (userProps) => mergeProps(userProps, propsList, "floating"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    floatingDeps
  );
  const getItemProps = React25.useCallback(
    (userProps) => mergeProps(userProps, propsList, "item"),
    // eslint-disable-next-line react-hooks/exhaustive-deps
    itemDeps
  );
  const getTriggerProps = React25.useCallback(
...
function useRole(context, props = {}) {
  ...
  const floatingId = React27.useMemo(() => {
    var _a;
  ...
  const item = React27.useCallback(({
    active,
    selected
  }) => {
    const commonProps = {
...
var DialogPortalContext = React29.createContext(void 0);
if (true) DialogPortalContext.displayName = "DialogPortalContext";
function useDialogPortalContext() {
  const value = React29.useContext(DialogPortalContext);
  if (value === void 0) {
...
var DialogPopup = React30.forwardRef(function DialogPopup2(componentProps, forwardedRef) {
  const {
    className,
    finalFocus,
    initialFocus,
...
var InternalBackdrop = React31.forwardRef(function InternalBackdrop2(props, ref) {
  const {
    cutout,
    ...otherProps
  } = props;
...
var DialogPortal = React32.forwardRef(function DialogPortal2(props, forwardedRef) {
  const {
    keepMounted = false,
    ...portalProps
  } = props;
...
function useDialogRoot(params) {
  ...
  const [ownNestedOpenDialogs, setOwnNestedOpenDialogs] = React37.useState(0);
  ...
  const activeTriggerProps = React37.useMemo(() => getReferenceProps(triggerProps), [getReferenceProps, triggerProps]);
  const inactiveTriggerProps = React37.useMemo(() => getTriggerProps(triggerProps), [getTriggerProps, triggerProps]);
...
var DialogStore = class extends ReactStore {
  constructor(initialState) {
    super(createInitialState(initialState), {
      popupRef: React38.createRef(),
      backdropRef: React38.createRef(),
      internalBackdropRef: React38.createRef(),
...
var DialogViewport = React40.forwardRef(function DialogViewport2(componentProps, forwardedRef) {
  const {
    className,
    render,
    children,
...
var DialogTitle = React41.forwardRef(function DialogTitle2(componentProps, forwardedRef) {
  const {
    render,
    className,
    id: idProp,
