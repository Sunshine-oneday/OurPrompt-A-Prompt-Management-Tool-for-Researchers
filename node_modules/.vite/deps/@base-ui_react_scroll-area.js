...
import {
  useIsoLayoutEffect,
  useStableCallback
} from "./chunk-UTWODLOY.js";
import {
  useRenderElement
} from "./chunk-VMIHYHOV.js";
...
var styleDisableScrollbar = {
  ...
  getElement(nonce) {
    return (0, import_jsx_runtime.jsx)("style", {
      nonce,
...
var ScrollAreaRoot = React3.forwardRef(function ScrollAreaRoot2(componentProps, forwardedRef) {
  const {
    render,
    className,
  ...
  const [scrollingX, setScrollingX] = React3.useState(false);
  const [scrollingY, setScrollingY] = React3.useState(false);
  const [touchModality, setTouchModality] = React3.useState(false);
  const [hasMeasuredScrollbar, setHasMeasuredScrollbar] = React3.useState(false);
  const [cornerSize, setCornerSize] = React3.useState(DEFAULT_SIZE);
  const [thumbSize, setThumbSize] = React3.useState(DEFAULT_SIZE);
  const [overflowEdges, setOverflowEdges] = React3.useState(DEFAULT_OVERFLOW_EDGES);
  const [hiddenState, setHiddenState] = React3.useState(DEFAULT_HIDDEN_STATE);
  const rootRef = React3.useRef(null);
  const viewportRef = React3.useRef(null);
  const scrollbarYRef = React3.useRef(null);
  const scrollbarXRef = React3.useRef(null);
  const thumbYRef = React3.useRef(null);
  const thumbXRef = React3.useRef(null);
  const cornerRef = React3.useRef(null);
  const thumbDraggingRef = React3.useRef(false);
  const startYRef = React3.useRef(0);
  const startXRef = React3.useRef(0);
  const startScrollTopRef = React3.useRef(0);
  const startScrollLeftRef = React3.useRef(0);
  const currentOrientationRef = React3.useRef("vertical");
  const scrollPositionRef = React3.useRef(DEFAULT_COORDS);
  ...
  return (0, import_jsx_runtime2.jsxs)(ScrollAreaRootContext.Provider, {
    value: contextValue,
...
var ScrollAreaViewportContext = React4.createContext(void 0);
if (true) ScrollAreaViewportContext.displayName = "ScrollAreaViewportContext";
function useScrollAreaViewportContext() {
  const context = React4.useContext(ScrollAreaViewportContext);
  if (context === void 0) {
...
var ScrollAreaViewport = React6.forwardRef(function ScrollAreaViewport2(componentProps, forwardedRef) {
  const {
    render,
    className,
    ...elementProps
  ...
  const programmaticScrollRef = React6.useRef(true);
  const lastMeasuredViewportMetricsRef = React6.useRef([NaN, NaN, NaN, NaN]);
  ...
  const viewportState = React6.useMemo(() => ({
    scrolling: scrollingX || scrollingY,
    hasOverflowX: !hiddenState.x,
    hasOverflowY: !hiddenState.y,
    overflowXStart: overflowEdges.xStart,
  ...
  return (0, import_jsx_runtime3.jsx)(ScrollAreaViewportContext.Provider, {
    value: contextValue,
    children: element
  });
});
...
var ScrollAreaScrollbarContext = React7.createContext(void 0);
if (true) ScrollAreaScrollbarContext.displayName = "ScrollAreaScrollbarContext";
function useScrollAreaScrollbarContext() {
  const context = React7.useContext(ScrollAreaScrollbarContext);
  if (context === void 0) {
...
var ScrollAreaScrollbar = React8.forwardRef(function ScrollAreaScrollbar2(componentProps, forwardedRef) {
  const {
    render,
    className,
  ...
  return (0, import_jsx_runtime4.jsx)(ScrollAreaScrollbarContext.Provider, {
    value: contextValue,
    children: element
  });
});
...
var ScrollAreaContent = React9.forwardRef(function ScrollAreaContent2(componentProps, forwardedRef) {
  const {
    render,
    className,
    ...elementProps
  } = componentProps;
  const contentWrapperRef = React9.useRef(null);
  const {
    computeThumbPosition
...
var ScrollAreaThumb = React10.forwardRef(function ScrollAreaThumb2(componentProps, forwardedRef) {
  const {
    render,
    className,
    ...elementProps
...
var ScrollAreaCorner = React11.forwardRef(function ScrollAreaCorner2(componentProps, forwardedRef) {
  const {
    render,
    className,
    ...elementProps
