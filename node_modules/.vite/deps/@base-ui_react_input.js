...
function useLabelableId(params = {}) {
  ...
  const hasRegisteredRef = React12.useRef(false);
  const hadExplicitIdRef = React12.useRef(id != null);
...
var FieldValidity = function FieldValidity2(props) {
  ...
  const combinedFieldValidityData = React14.useMemo(() => getCombinedFieldValidityData(validityData, invalid), [validityData, invalid]);
  ...
  return (0, import_jsx_runtime4.jsx)(React14.Fragment, {
...
var FieldItemContext = React15.createContext({
  disabled: false
});
...
var CheckboxGroupContext = React16.createContext(void 0);
if (true) CheckboxGroupContext.displayName = "CheckboxGroupContext";
function useCheckboxGroupContext(optional = true) {
  const context = React16.useContext(CheckboxGroupContext);
...
var FieldItem = React17.forwardRef(function FieldItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
    disabled: disabledProp = false,
  ...
  const fieldItemContext = React17.useMemo(() => ({
    disabled
  }), [disabled]);
  const element = useRenderElement("div", componentProps, {
    ref: forwardedRef,
